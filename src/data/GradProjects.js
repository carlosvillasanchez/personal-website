...
export default [
  ...
  {
    id: 4,
    title: "A game platform for Raspberry pi",
    icon: game,
    description: "A game platform developed in C for Raspberry Pi. The software platform was integrated with also hardware tools as game controllers. We equipped this platform with several games: Brick breaker, pong, snake, and tetrix. The GitHub link is to one of the games.",
    githubPath: "https://github.com/carlosvillasanchez/Raspberry-Pi-Tetrix",
    demoPath: null,
    year: "2017",
    techUsed: "C, Raspberry Pi, wiringPi"
  },
]
